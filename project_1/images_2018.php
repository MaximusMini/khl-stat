...
function ajax_temp(template_number){
    ...
    if(template_number==3){file_template='template_php/temp_2018/temp_3.php'}
    if(template_number==4){file_template='template_php/temp_2018/temp_4.php'}
    if(template_number==5){file_template='template_php/temp_2018/temp_5.php'}
    if(template_number==6){file_template='template_php/temp_2018/temp_6.php'}
    if(template_number==7){file_template='template_php/temp_2018/temp_7.php'}
    if(template_number==8){file_template='template_php/temp_2018/temp_8.php'}
    if(template_number==9){file_template='template_php/temp_2018/temp_9.php'}
    if(template_number==10){file_template='template_php/temp_2018/temp_10.php'}
    if(template_number==11){file_template='template_php/temp_2018/temp_11.php'}
    // плей-офф
    if(template_number=='p1'){file_template='template_php/temp_2018/temp_p1.php'}
    if(template_number=='p2'){file_template='template_php/temp_2018/temp_p2.php'}
    $.ajax({
...
function ajax_temp1(){
    ...
    $.ajax({
       data:'team_1='+team_1+'&team_2='+team_2+'&date_match='+date_match+'&number_match='+number_match,
        type:"POST",
        url:"template_php/temp_2018/temp_1.php",
        success: function(){
            alert('Load was performed.');
        }
    });  
...
function ajax_temp2(){
    ...
    $.ajax({
      data:'team_1='+team_1+'&team_2='+team_2+'&date_match='+date_match+'&number_match='+number_match,
        type:"POST",
        url:"template_php/temp_2018/temp_2.php",
        success: function(){
            alert('Load was performed.');
        }
    });  
...
function textMatch(){
    ...
    $.ajax({
        data:'team_1='+team_1+'&team_2='+team_2+'&date_match='+date_match+'&number_match=' +number_match,
        type:"POST",
        url:'template_php/temp_2018/temp_text.php',
        success: function(){
