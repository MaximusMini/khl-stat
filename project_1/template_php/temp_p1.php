...
// дата
    imagettftext($image, 13, 0, 300, 130, $green , $font, $date_match);
// конференция
    //imagettftext($image, 11, 0, 100, 338, $grey, $font, $conf_team_1[0]);
    //imagettftext($image, 11, 0, 515, 338, $grey, $font, $conf_team_2[0]);
// место в конференции
    imagettftext($image, 14, 0, 120, 384, $grey, $font, $row_team_1['place']);
    imagettftext($image, 14, 0, 565, 384, $grey, $font, $row_team_2['place']);
// проведенные игры
...
// набранные очки
    ...
    //echo "<br>row_team_1['scores']".$row_team_1['scores'];
    imagettftext($image, 14, 0, 120, 477, $grey, $font, $row_team_1['scores']);
    imagettftext($image, 14, 0, 565, 477, $grey, $font, $row_team_2['scores']);
// победы
...
// поражения
    imagettftext($image, 14, 0, 120, 665, $grey, $font, $row_team_1['clear_defeat']);
    imagettftext($image, 14, 0, 565, 665, $grey, $font, $row_team_2['clear_defeat']);
// поражения ОТ
    imagettftext($image, 14, 0, 120, 710, $grey, $font, $row_team_1['ot_defeat']);
    imagettftext($image, 14, 0, 565, 710, $grey, $font, $row_team_2['ot_defeat']);
// поражения Б
    imagettftext($image, 14, 0, 120, 758, $grey, $font, $row_team_1['b_defeat']);
    imagettftext($image, 14, 0, 565, 758, $grey, $font, $row_team_2['b_defeat']);
// заброшенные шайбы
    imagettftext($image, 14, 0, 120, 806, $grey, $font, $row_team_1['throw_puck']);
    imagettftext($image, 14, 0, 565, 806, $grey, $font, $row_team_2['throw_puck']);
// сохраняем изображение
    imagepng($image,'../template_img/new/match_'.$number_match.'_temp-p1.png',9);
