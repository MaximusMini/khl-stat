...
function main_pars($num_m){
    ...
    $penalty_kill_str1_1 = $file_phpQuery->find('.b-data_row:nth-child(6) .dataTables_wrapper:nth-child(4) table.dataTable.stripe.compact.row-border.hl.no-footer.rc.m-table_small:nth-child(1) tbody tr:nth-child(1) td:nth-child(7)')->text();
    $penalty_kill_str1_2 = $file_phpQuery->find('.b-data_row:nth-child(6) .dataTables_wrapper:nth-child(4) table.dataTable.stripe.compact.row-border.hl.no-footer.rc.m-table_small:nth-child(1) tbody tr:nth-child(1)  td:nth-child(8)')->text();
    $penalty_kill_str2_1 = $file_phpQuery->find('.b-data_row:nth-child(6) .dataTables_wrapper:nth-child(4) table.dataTable.stripe.compact.row-border.hl.no-footer.rc.m-table_small:nth-child(1) tbody tr:nth-child(2) td:nth-child(7)')->text();
    $penalty_kill_str2_2 = $file_phpQuery->find('.b-data_row:nth-child(6) .dataTables_wrapper:nth-child(4) table.dataTable.stripe.compact.row-border.hl.no-footer.rc.m-table_small:nth-child(1) tbody tr:nth-child(2)  td:nth-child(8)')->text();
    // проверка по названию команды
    $name_str1=$file_phpQuery->find('.b-data_row:nth-child(6) .dataTables_wrapper:nth-child(4) table.dataTable.stripe.compact.row-border.hl.no-footer.rc.m-table_small:nth-child(1) tbody tr:nth-child(1)  td:nth-child(1)')->text();// название команды в первой строке
    $name_str2=$file_phpQuery->find('.b-data_row:nth-child(6) .dataTables_wrapper:nth-child(4) table.dataTable.stripe.compact.row-border.hl.no-footer.rc.m-table_small:nth-child(1) tbody tr:nth-child(2)  td:nth-child(1)')->text();// название команды во второй строке
    echo '<br>$name_str1'.$name_str1;
    if($name_str1 == $p['name_t1']){
        $p['penalty_kill_t1'] = $penalty_kill_str2_1.'/'.$penalty_kill_str2_2;
        $p['penalty_kill_t2'] = $penalty_kill_str1_1.'/'.$penalty_kill_str1_2;
    }else{
        $p['penalty_kill_t1'] = $penalty_kill_str1_1.'/'.$penalty_kill_str1_2;
        $p['penalty_kill_t2'] = $penalty_kill_str2_1.'/'.$penalty_kill_str2_2;
    }
    // силовые приемы
...
function imageTemplate(){
    ...
    $image = imagecreatefrompng('protocol_playoff.png');
    // установка шрифтов
    ...
    // втавка имен команд
    switch($p['name_t1']){
        case 'Авангард':imagettftext($image, 65, 0, 290, 265, $white, $font_BigNoodle, $p['name_t1']); break;
        case 'Автомобилист':imagettftext($image, 65, 0, 165, 265, $white, $font_BigNoodle, $p['name_t1']); break;
        case 'Амур':imagettftext($image, 65, 0, 435, 265, $white, $font_BigNoodle, $p['name_t1']); break;
        ...
        case 'ЦСКА':imagettftext($image, 65, 0, 435, 265, $white, $font_BigNoodle, $p['name_t1']); break;
