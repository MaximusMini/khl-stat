...
function main_pars($num_m){
    ...
    $res_curl = curl_get ('https://www.khl.ru/game/472/'.$num_m.'/protocol/'); // б
    //$res_curl = file_get_contents('protocol.txt');
    $res_resume = curl_get ('https://www.khl.ru/game/472/'.$num_m.'/resume/');
    ...
    $penalty_kill_t1_one = $file_phpQuery->find('.b-data_row:nth-child(6) div:nth-child(4) table tbody tr:nth-child(2) td:nth-child(7)')->text();
    echo '<br>$penalty_kill_t1_one-'.$penalty_kill_t1_one;
    $penalty_kill_t1_two = $file_phpQuery->find('.b-data_row:nth-child(6) div:nth-child(4) table tbody tr:nth-child(1)  td:nth-child(8)')->text();
    echo '<br>$penalty_kill_t1_two-'.$penalty_kill_t1_two;
    $p['penalty_kill_t1'] = $penalty_kill_t1_one.'/'.$penalty_kill_t1_two;
    $penalty_kill_t2_one = $file_phpQuery->find('.b-data_row:nth-child(6) .dataTables_wrapper:nth-child(4) table.dataTable.stripe.compact.row-border.hl.no-footer.rc.m-table_small:nth-child(1) tbody tr:nth-child(1) td:nth-child(7)')->text();
    ...
    //$num_row=
    // силовые приемы
    $p['body_check_t1'] = trim($file_phpQuery->find('.b-data_row:nth-child(8) table tbody tr:nth-child(5) td:nth-child(3)')->text());
    $p['body_check_t2'] = trim($file_phpQuery->find('.b-data_row:nth-child(8) table tbody tr:nth-child(5) td:nth-child(6)')->text());
    // блокированные броски
    $p['block_throw_t1'] = trim($file_phpQuery->find('.b-data_row:nth-child(8) table tbody tr:nth-child(5) td:nth-child(2)')->text());
    $p['block_throw_t2'] = trim($file_phpQuery->find('.b-data_row:nth-child(8) table tbody tr:nth-child(5) td:nth-child(5)')->text());
    echo '<br>силовые приемы '.$p['block_throw_t1'];
    echo '<br>силовые приемы '.$p['block_throw_t2'];
    // время в атаке
    $p['atack_time_t1'] = trim($file_phpQuery->find('.b-data_row:nth-child(8) table tbody tr:nth-child(5) td:nth-child(4)')->text());
    $p['atack_time_t2'] = trim($file_phpQuery->find('.b-data_row:nth-child(8) table tbody tr:nth-child(5) td:nth-child(7)')->text());
...
function imageTemplate(){
    ...
    $image = imagecreatefrompng('protocol_playoff_ot.png');
    // установка шрифтов
    ...
    // вызов функции определения позиции имени команды хозяев 
...
//    imagettftext($image, 40, 0, 620, 145, $bl_blue, $font, $p['match_len']);// Б
